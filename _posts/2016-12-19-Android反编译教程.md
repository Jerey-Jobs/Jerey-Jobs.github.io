...
需要使用if命令打入以下apk
java -jar apktool_2.2.2.jar if  
./target/common/obj/APPS/miui_intermediates/package-export.apk
./target/common/obj/APPS/framework-res_intermediates/package-export.apk
./target/common/obj/APPS/framework-ext-res_intermediates/package-export.apk
./target/common/obj/APPS/miuisystem_intermediates/package-export.apk
